...
class MovieProfileAdapater(val listMovieProfile: List<MovieProfileModel>) :
    RecyclerView.Adapter<MovieProfileAdapater.MovieProfileViewHolders>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieProfileViewHolders {
        ...
        return MovieProfileViewHolders(
            layoutInflater.inflate(
                R.layout.item_principal_images,
                parent,
                false
            )
        )
